...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-20 w-full max-w-6xl transition-opacity duration-300 ${
          isGsapLoaded ? "opacity-100" : "opacity-0"
        }`}
      >
        {/* 1. HEADLINE SECTION */}
        <div className="flex flex-col pl-6 pr-5 py-10 items-center md:items-start relative z-30 w-full">
          ...
          <div className="relative -mt-2 md:-mt-6 ml-0 md:ml-2">
            <div className="hero-line relative z-20 inline-block transform -rotate-2 hover:rotate-0 transition-transform duration-300 origin-bottom-left">
              <h1 className="text-[6vw] md:text-[6vw] uppercase leading-[0.85] tracking-tighter text-black bg-[#FBBF24] px-4 pt-4 pb-2 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] whitespace-nowrap">
                COMES TOGETHER
              </h1>
            </div>
          </div>
        ...
        <div className="mt-12 md:mt-20 flex flex-wrap justify-center md:justify-start gap-4 md:gap-5 relative z-20">
          <div className="tag-pill flex items-center gap-2 border-2 border-black bg-black text-white px-4 py-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)] hover:-translate-y-1 transition-transform cursor-default">
            <Hammer size={18} />
            <span
              className={`text-xs md:text-sm font-bold uppercase ${mono.className}`}
            >
              Built With Students
            </span>
          </div>
          ...
          <div className="tag-pill flex items-center gap-2 border-2 border-black bg-[#FBBF24] px-4 py-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-transform cursor-default">
            ...
            <span
              className={`text-xs md:text-sm font-bold uppercase text-black ${mono.className}`}
            >
              Open Build
            </span>
          </div>

          <div className="tag-pill flex items-center gap-2 border-2 border-black bg-[#A855F7] text-white px-4 py-3 shadow-[4px_4px_0px_0px_rgba(0,0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-transform cursor-default">
              ...
              <div className="absolute bottom-4 right-4 md:right-0 w-[130px] md:w-[180px] z-20">
                <div className="bg-black border-4 border-black rounded-[2rem] p-1.5 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.5)]">
                  <div className="bg-white aspect-[9/19.5] w-full rounded-[1.5rem] relative overflow-hidden border border-gray-400">
                    ...
                    <div
                      className={`absolute bottom-4 left-1/2 -translate-x-1/2 bg-black text-white text-[8px] font-bold px-2 py-1 uppercase whitespace-nowrap ${mono.className}`}
                    >
                      Beta_Build
                    </div>
                  </div>
          ...
          <div className="md:col-span-5 relative z-20">
            <div className="bg-white border-4 border-black p-6 md:p-8 shadow-[8px_8px_0px_0px_#000] rotate-1 md:rotate-2 hover:rotate-0 transition-transform duration-300">
              <div className="flex justify-between items-start mb-6">
                <div
                  className={`bg-black text-white px-3 py-1 text-xs font-bold uppercase inline-flex items-center gap-2 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,0.2)] ${mono.className}`}
                >
              ...
              <h2
                className={`text-5xl md:text-6xl uppercase leading-[0.85] tracking-tighter mb-6 text-black ${archivo.className}`}
              >
                Built By <br />
                <span className="relative inline-block mt-2">
                  <span className="absolute inset-0 bg-[#FBBF24] translate-x-1 translate-y-1 border-2 border-black"></span>

                  <span className="relative bg-white border-2 border-black px-3 z-10 block">
                    Students.
                  </span>
                </span>
              </h2>
              ...
              <p className="text-base md:text-lg font-medium leading-relaxed text-black mb-8">
                We aren't a corporation. We are <b>B.Tech students</b> sitting
                in the same exam halls as you.
                <br className="hidden md:block" />
                We are building this app because{" "}
                <span className="bg-[#10B981]/20 px-1 font-bold border-b-4 border-[#10B981]">
                  we need it just as much as you do.
                </span>
              </p>
                  ...
                  <div className="relative flex items-center justify-between p-3 border-2 border-black bg-white">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] md:text-xs text-gray-600 font-bold leading-none mt-0.5">
                          We write the same exams you do.
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative flex items-center justify-between p-3 border-2 border-black bg-white">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] md:text-xs text-gray-600 font-bold leading-none mt-0.5">
                          We use this app to survive our own semesters.
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <div className="hero-cta mt-20 md:mt-32 flex flex-col items-start pb-4 relative z-30 w-full">
          ...
          >
            ...
            <span>
              Created by B.Techs <span className="text-gray-300 mx-1">//</span>{" "}
              For B.Techs
            </span>
          </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-4">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 rounded-full border-2 border-black overflow-hidden z-0 bg-white shadow-sm"
                  >
                    <img
                ...
                <div
                  className={`w-12 h-12 rounded-full bg-[#FBBF24] border-2 border-black flex items-center justify-center text-xs font-black z-10 shadow-sm ${mono.className}`}
                >
                  +{userCount}
                </div>
              </div>
              ...
              <div className="flex flex-col">
                <span
                  className={`text-sm font-bold uppercase tracking-tight ${archivo.className}`}
                >
                  Early Supporters
                </span>

                <span
                  className={`text-[10px] font-bold text-[#10B981] uppercase tracking-widest flex items-center gap-1 ${mono.className}`}
                >
                  <Zap size={10} fill="currentColor" /> Downloading Now
                </span>
              </div>
            </div>
          </div>
